...
public class SelenideWithLabels {
    ...
    @Story("Пользователь должен иметь возможность просматривать созданные задачи в репозитории")
...
// Фича и Стори не отображаются в алюре у меня, почему????
    ...
    @Test
    @DisplayName("Параметрайз")
        //В отчете отображаются введенные параметры
    void parametersTest() {
